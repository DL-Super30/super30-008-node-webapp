                ...
                <div className="grid grid-cols-2 gap-4 px-3">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex">
                      ...
                      {item.opportunityStatus?.editEnabled && (
                        <button
                          onClick={() => saveDetails("opportunityStatus")}
                        >
                          <Image
                            src="/images/save-icon.png"
                            alt="save-icon"
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex">
                      ...
                      {!item.lostOpportunityReason?.editEnabled && (
                        <button
                          onClick={() =>
                            enableEditable("lostOpportunityReason")
                          }
                        >
                          <Image
                            src="/images/edit-icon.png"
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex">
                      ...
                      {!item.registeredDate?.editEnabled && (
                        <button
                          onClick={() => enableEditable("registeredDate")}
                        >
                          <Image
                            src="/images/edit-icon.png"
                            alt="edit-icon"
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex">
                      ...
                      {!item.alternatePhone?.editEnabled && (
                        <button
                          onClick={() => enableEditable("alternatePhone")}
                        >
                          <Image
                            src="/images/edit-icon.png"
                            alt="edit-icon"
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex">
                      ...
                      {!item.preferableTime?.editEnabled && (
                        <button
                          onClick={() => enableEditable("preferableTime")}
                        >
                          <Image
                            src="/images/edit-icon.png"
                            alt="edit-icon"
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex">
                      ...
                      {!item.courseComments?.editEnabled && (
                        <button
                          onClick={() => enableEditable("courseComments")}
                        >
                          <Image
                            src="/images/edit-icon.png"
                            alt="edit-icon"
